...
1. `specs/openspec/project.md` - Project conventions
2. `specs/openspec/changes/{change-id}/proposal.md` - What and why
3. `specs/openspec/changes/{change-id}/tasks.md` - Implementation checklist
4. `specs/openspec/changes/{change-id}/specs/*.md` - Delta specifications
