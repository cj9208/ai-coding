...
2. Create the change directory structure under `specs/openspec/changes/`
...
```bash
mkdir -p specs/openspec/changes/{change-id}/specs
```

### Step 3: Generate proposal.md

Create `specs/openspec/changes/{change-id}/proposal.md`:
...
Create `specs/openspec/changes/{change-id}/tasks.md`:
...
Create `specs/openspec/changes/{change-id}/specs/{component}_delta.md`:
...
### Files Generated:
- `specs/openspec/changes/{change-id}/proposal.md`
- `specs/openspec/changes/{change-id}/tasks.md`
- `specs/openspec/changes/{change-id}/specs/{component}_delta.md`
...
- Read existing specs in `specs/openspec/specs/` to understand current state
- Reference `specs/openspec/project.md` for project conventions
