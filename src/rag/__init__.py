...
``docs/rag-subsystem-design.md``: the pipeline shape and the six data
contracts are the architecture; every retrieval technology behind a
protocol seam (FTS5 now, grep/vector/rerank later) is a plug-in chosen by
